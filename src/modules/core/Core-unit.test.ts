...
describe('Core 단위 테스트', () => {
  ...
  test('rerenderChildren() - 테스트 케이스 1', () => {
    ...
    expect(dom.window.document.querySelector('h3')!.textContent).toBe('할 일 : 2')
    expect(dom.window.document.querySelectorAll('li').length).toBe(2)

    // 상태 업데이트 후
    rootComponent.updateUserInfo()
    expect(dom.window.document.querySelector('h2')!.textContent).toBe('sangyoon')

    rootComponent.popTodo()
    expect(dom.window.document.querySelector('h3')!.textContent).toBe('할 일 : 1')
  ...
  test('rerenderChildren() - 테스트 케이스 2', () => {
    ...
    expect(dom.window.document.querySelector('h3')!.textContent).toBe('나이 : 20')
    expect(dom.window.document.querySelector('h5')!.textContent).toBe('형제 : 1명')
    expect(dom.window.document.querySelector('h6')!.textContent).toBe('자매 : 1명')

    // 상태 업데이트 후
    rootComponent.updateUserInfo()
    expect(dom.window.document.querySelector('h2')!.textContent).toBe('sangyoon')
    expect(dom.window.document.querySelector('h3')!.textContent).toBe('나이 : 50')
    expect(dom.window.document.querySelector('h5')!.textContent).toBe('형제 : 1명')
    expect(dom.window.document.querySelector('h6')!.textContent).toBe('자매 : 1명')
    ...
    expect(dom.window.document.querySelector('h5')!.textContent).toBe('형제 : 1명') // 뎁스가 3뎁스라 바뀌지 않음
    expect(dom.window.document.querySelector('h6')!.textContent).toBe('자매 : 1명') // 뎁스가 3뎁스라 바뀌지 않음
  })
